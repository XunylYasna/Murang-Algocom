def solve(L, n, coverage):
    ...
    #if there's no person who can cover first or last 
    if(coverage[0][0] != 1 or coverage[len(coverage)-1][1] != L):
        return "'Salem's Lot is doomed."

    j = 0
    for i in range(n): #gets all array that has farthest reach and within interval
